...
LogoutView.next_page = reverse_lazy('home') # evaluate only when needed with lazy variant
LogoutView.next_page = next_page_property # or it can be done via property pattern
